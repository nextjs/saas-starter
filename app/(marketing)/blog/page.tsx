  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 min-h-[80vh]">
      ...
      <div className="grid gap-8">
        ...
        <div className="p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <h2 className="text-xl font-semibold mb-2">如何使用MCP SaaS Kit快速构建应用</h2>
          <p className="text-gray-500 text-sm mb-4">2023年11月15日</p>
          <p className="text-gray-600">
            在这篇文章中，我们将探讨如何利用MCP SaaS Kit的强大功能快速构建和部署您的SaaS应用...
          </p>
        </div>

        <div className="p-6 border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow">
          <h2 className="text-xl font-semibold mb-2">SaaS应用的最佳实践</h2>
          <p className="text-gray-500 text-sm mb-4">2023年10月22日</p>
          <p className="text-gray-600">
            构建成功的SaaS应用需要考虑多方面因素。本文将分享一些行业最佳实践，帮助您打造出色的用户体验...
          </p>
        </div>
      </div>
    </div>
